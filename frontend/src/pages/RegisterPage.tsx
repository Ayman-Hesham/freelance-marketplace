      ...
      <div className="w-1/2 h-full">
        <img 
          ...
          onError={(e) => {
            ...
            target.src = "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1484&q=80";
          }}
        />
      </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-6">
              ...
              <input
                id="name"
                type="text"
                className={`w-full px-4 py-3 rounded-lg border ${errors.name ? 'border-red-500 focus:ring-red-300' : 'border-gray-300 focus:ring-primary-300'} focus:outline-none focus:ring-2 focus:border-transparent`}
                placeholder="John Doe"
                {...register("name", { 
                  required: "Name is required", 
                  validate: value => 
                    value.replace(/\s+/g, '').length >= 3 || "Name must be at least 3 characters excluding spaces",
                  maxLength: {
                    value: 15,
                    message: "Name must be less than 15 characters excluding spaces"
                  }
                })}
              />
